"""Shared Plotly styling — dark research charts with correct axis scaling."""
...
def apply_white_theme(fig, *, rangemode: Optional[str] = None, **extra_layout):
    """
    Dark chart chrome without clobbering axis types / autorange / category order.
    ...
    fig.update_layout(
        ...
        font=dict(color=INK, family="Segoe UI, system-ui, sans-serif", size=12),
